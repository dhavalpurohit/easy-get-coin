    ...
    <div class="flex items-center w-full space-x-4">
        ...
        <div class="relative w-full">
            <div class="relative flex-1 h-6 sm:h-7 bg-periwinkle rounded-[9px]">
                ...
                <div :style="{ left: progress + '%' }" :class="{ '!-ml-0.5': progress === 0 }"
                    class="absolute -top-[2px] sm:-top-[3px] -ml-4 sm:-ml-8 h-7 w-7 sm:h-[34px] sm:w-[34px] light-pink-to-dark-pink rounded-full shadow-lightBlack">
                </div>
            </div>
            <div
